export default function AboutUs() {
  return (
    <div id="aboutUs" className="bg-[#98c03b] flex justify-end items-center flex-wrap lg:h-[911px]">
      <div className="text-container text-end w-full lg:w-[50%] p-4 lg:p-0 lg:pr-4">
        <h3 className="text-white text-2xl">Há 16 anos limpando o mundo gota a gota</h3>
      ...
      <div className="cards-container w-full lg:w-[50%] flex justify-center items-center flex-col lg:justify-between lg:items-center">
        <div className="card flex justify-center items-center flex-col w-[90%] lg:w-[450px] h-[254px] rounded-[30px] bg-gray-200 shadow-lg my-4 lg:my-0">
          <p>Missão</p>
